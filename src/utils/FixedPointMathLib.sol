...
library FixedPointMathLib {
    ...
    function fpow(
        ...
        // TODO: do we need unchecked at all here it's assembly?
    ...
    function sqrt(uint256 x) internal pure returns (uint256 z) {
        if (x == 0) return 0;
            ...
            // TODO: does it make a difference only unchecking this block instead of whole func?
            // TODO: we need concrete tests to measure
            unchecked {
                r = (r + x / r) >> 1;
                r = (r + x / r) >> 1;
                r = (r + x / r) >> 1;
                ...
                // TODO: can we use <= here? which is cheaper?
                return (r < r1 ? r : r1);
            }
        }
    }
