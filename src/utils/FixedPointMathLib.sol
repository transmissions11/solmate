...
library FixedPointMathLib {
    ...
    function sqrt(uint256 x) internal pure returns (uint256 z) {
        assembly {
            ...
            // Goal is to get z*z*y within a small factor of x. More iterations will
            // get y in a tighter range. Currently, we will have y in [256, 256*2^16).
            // We ensure y >= 256 so that the relative difference between y and y+1 is small.
            ...
            // Since this case is rare, we save gas on the assignment and repeat division in the rare case.
