...
abstract contract ERC1155A {
    ...
    // `mstore(0x00, or(_IS_APPROVED_FOR_ALL_SALT, owner))`
    // `mstore(0x20, operator)`
    // `keccak256(0x00, 0x40)`
    uint256 private constant _IS_APPROVED_FOR_ALL_SALT =
        0xc57ff912ba5dfcdc45e690970000000000000000000000000000000000000000;

    // `or(_OWNER_OF_SALT, tokenId)`
    uint256 private constant _OWNER_OF_SALT = 0x8d3216563a4520cb5303c6d05b3d01bc4465c4c0ec7c489e0000000000000000;

    function totalBalanceOf(address owner) public view virtual returns (uint256 result) {}
